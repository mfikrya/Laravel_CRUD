...
@include('layouts.headers.cards')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2"><font color= #212529>  <span class="fa fa-edit fa-fw"></span> Update Progress 1007</font></h1>
    </div>
    
                
                <form method="POST" action="{{route('sloc.update007',[$data->id])}}" autocomplete="off" enctype="multipart/form-data">
                {{method_field('put')}}
                {{csrf_field()}}
                ...
                <select name="penyebab_sloc" class="form-control" style="width:276" required>
                    <option value="">----- Pilih -----</option>
                                        <option value="LPPBDO/LPPBPO">LPPBDO/LPPBPO</option>
