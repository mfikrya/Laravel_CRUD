...
<div class="content-wrapper">
    ...
    <div class="container">
    	...
    	<a href="sloc.export_excel" class="btn btn-success my-3">Download Semua Data SLoc</a>
        <a href="sloc.export_evident" class="btn btn-success my-3">Download File Evident</a>
    	<button type="button" class="btn btn-success my-3" data-toggle="modal" data-target="#importExcel">Upload Data SLoc </button>
        <button type="button" class="btn btn-success my-3" data-toggle="modal" data-target="#deleteConfirm1">Hapus Semua Data</button>
        <form method="GET" action="sloc.exportByMonth" class="d-inline-block">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <br>
                    <button type="submit" class="btn btn-success my-3">Download Data Berdasarkan Bulan</button>
                </div>
            </div>
        </form>
        @endif
                    ...
                    <tr>
                        ...
                        <td>{{$item->status_sloc}}</td>
                            ...
                            <td>
                                ...
                                @endif
                            <div class="btn-group" role="group" aria-label="Grup"><a href="{{route('sloc.views',[$item->id])}}" type="button" class="btn btn-info btn-sm">View</a>
